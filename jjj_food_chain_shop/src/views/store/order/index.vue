<template>
  ...
  <div class="user">
          ...
          <el-table-column fixed="right" label="操作" width="160">
            <template slot-scope="scope" v-if="!scope.row.is_top_row">
              ...
              <el-button v-if="scope.row.order_status.value==10&&scope.row.pay_status.value==20"
                @click="refundClick(scope.row)" type="text" size="small" v-auth="'/store/Operate/refund'">退款</el-button>
              <el-button v-if="scope.row.order_status.value==10" @click="cancelClick(scope.row)" type="text"
                size="small" v-auth="'/store/Operate/confirmCancel'">取消</el-button>
              <el-button v-if="scope.row.order_status.value==10&&scope.row.pay_status.value==20"
                @click="verifyClick(scope.row)" type="text" size="small" v-auth="'/store/operate/extract'">核销
              </el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <!--处理-->
    <refund v-if="open_refund" :open_edit="open_refund" :order_no="order_no"
